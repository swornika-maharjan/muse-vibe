    ...
    return allSongs.when(
      data: (songs) {
        ...
        return GestureDetector(
          behavior: HitTestBehavior.opaque, // Capture gestures in empty spaces
          onHorizontalDragEnd: (details) {
            if (details.primaryVelocity != null &&
                details.primaryVelocity! > 0) {
              Navigator.pop(context); // Close screen on right swipe
            }
          },
          onVerticalDragEnd: (details) {
            if (details.primaryVelocity != null &&
                details.primaryVelocity! > 0) {
              Navigator.pop(context); // Close screen on downward swipe
            }
          },
          child: Container(
              ...
              appBar: AppBar(
                ...
                actions: [
                  IconButton(
                    ...
                    onPressed: () async {
                      // Stop the music when the cross button is clicked
                      await ref
                          ...
                          children: [
                            IconButton(
                              onPressed: currentIndex > 0
                                  ? () => songNotifier
                                      .playPrevious(songs[currentIndex - 1])
                                  : null,
                              icon: const Icon(
